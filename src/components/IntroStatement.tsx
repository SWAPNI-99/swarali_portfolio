      ...
      <div className="mx-auto max-w-[92rem]">
        ...
        <Reveal>
          <p className="mt-8 max-w-4xl font-serif text-[clamp(1.7rem,3.4vw,3.15rem)] leading-[1.15] tracking-editorial text-ink-900">
            A reporter formed in print, sharpened in television, and now working on the field -
            covering remote mining belts to counting-day floors, disaster sites and firing ranges.
          </p>
        </Reveal>
        <Reveal delay={120}>
          <div className="mt-14 grid gap-8 sm:grid-cols-4">
            {[
              ...
              { k: '02', t: 'Broadcast', d: 'Times Network · Mirror Now' },
              { k: '03', t: 'Multimedia', d: 'MIT WPU · NLC Samachar' },
              { k: '04', t: 'Broadcast', d: 'Republic Media Network' },
            ].map((item) => (
